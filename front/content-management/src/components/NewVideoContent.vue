<template>
  <div class="new-doc-content">
    <h3 class="mt-3 doc-title">Create Video content</h3>
    ...
    <b-row class="doc-file-input mt-3">
        ...
        <div class="label-container">
            ...
            id="file" 
            ref="inputFile"
            accept=".mp4,.mov,.wmv,.m4a,.webm,.mkv" 
        ...
        <div class="label-container">
            ...
            id="attachment" 
            ref="inputAttach"
            accept=".srt,.ssa,.txt,.vvt,.sbv,.ttml"
    ...
    <div id="snackbar" :class="[showSuccessToast ? 'show': '']">New video content added!</div>
